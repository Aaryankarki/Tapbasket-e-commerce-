...
<body>
        ...
        <div class="register-container">
            <div class="register-header">
                <a href="index.jsp" class="logo">
                    <i class="fas fa-shopping-basket"></i> TapBasket
                </a>
        ...
        <div class="container">
            <div class="footer-content">
                <div class="footer-section">
                    ...
                    <p>Your one-stop destination for all electronic needs. We provide high-quality products at competitive prices.</p>
                </div>
    ...
    <script>
        ...
        passwordInput.addEventListener('input', function () {
            ...
            if (strength === 1) passwordStrengthMeter.classList.add('strength-weak');
            else if (strength === 2) passwordStrengthMeter.classList.add('strength-medium');
            else if (strength === 3) passwordStrengthMeter.classList.add('strength-good');
            else if (strength === 4) passwordStrengthMeter.classList.add('strength-strong');
        });
