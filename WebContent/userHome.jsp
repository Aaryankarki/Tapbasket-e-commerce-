    ...
    <%@ page
        ...
        <body>
            <% /* Checking the user credentials */ String userName=(String) session.getAttribute("username"); String
                ...
                response.sendRedirect("login.jsp?message=Session Expired, Login Again!!"); } ProductServiceImpl
                prodDao=new ProductServiceImpl(); List<ProductBean> products = new ArrayList<ProductBean>();
                                                    ...
                                                    <% if (cartQty==0) { %>
                                                        ...
                                                        <form method="post" action="./AddtoCart">
                                                            ...
                                                            <input type="hidden" name="pid"
                                                                value="<%= product.getProdId() %>">
                                                            <input type="hidden" name="pqty" value="1">
                                                            <button type="submit" class="btn btn-secondary">Buy
                                                                Now</button>
                                                        </form>
                                                        <% } else { %>
                                                            <form method="post" action="./AddtoCart">
